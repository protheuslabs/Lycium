...
from app.routes import course_routes, learning_routes, local_routes, portfolio_job_routes, source_index_routes, submission_grading_routes
...
def create_app() -> FastAPI:
    ...
    source_index_routes.register(app)
    submission_grading_routes.register(app)
    return app
