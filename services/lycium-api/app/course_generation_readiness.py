...
def build_generation_readiness_report(
    *,
    ...
    source_gate = source_packet_quality_gate(synthesis)
    ...
    issues = []
    if evidence_count < minimum_sources:
        issues.append(
            {
    ...
    return {
        ...
        "conceptCoverage": {
            ...
            "coverageRatio": concept_artifacts.get("conceptCoverageRatio"),
            "minimumCoverageRatio": concept_artifacts.get("minimumConceptCoverageRatio"),
            "requiredConceptCount": concept_artifacts.get("conceptCandidateCount"),
            "coveredConceptCount": concept_artifacts.get("coveredConceptCandidateCount"),
            "uncoveredConcepts": missing_concepts,
            "coverageRows": concept_artifacts.get("conceptCoverage", []),
        },
