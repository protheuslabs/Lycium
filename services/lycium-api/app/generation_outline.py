...
def _fallback_outline(prompt: str, module_count: int, goals: list[str], *, level: str | None = None) -> dict[str, Any]:
...
def build_outline(
    ...
    *,
    ...
    if not objects:
        return _fallback_outline(prompt, desired_module_count, goals, level=level)
